      ...
      <div className="p-4 md:p-8 grid grid-cols-2 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <section className="md:col-span-2 mt-4">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link 
              ...
              className="text-cyan-500 hover:text-cyan-400 text-sm font-semibold flex items-center gap-1"
            >
              View Full Roadmap
        ...
        <section className="md:col-span-2 mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-zinc-50 dark:bg-zinc-800/50 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800">
              <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-2">EPK Status</h3>
              <p className="text-zinc-600 dark:text-zinc-400 text-sm mb-4">
                Your EPK was last viewed 14 times this week.
              </p>
              <button className="flex items-center gap-2 px-6 py-2 bg-zinc-200 dark:bg-zinc-700 hover:bg-zinc-300 dark:hover:bg-zinc-600 text-zinc-900 dark:text-white rounded-lg font-semibold transition-all text-sm">
                <Share2 size={16} />
                Share EPK Link
              </button>
            </div>
