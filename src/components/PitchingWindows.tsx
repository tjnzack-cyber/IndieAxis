...
const SEED_WINDOWS: Omit<PitchingWindow, 'id'>[] = [
  ...
  { title: 'Sync Licensing — Music Vine', category: 'Sync', month: 'Ongoing', deadline: 'Rolling', description: 'Submit music for TV, film and ad placements via Music Vine's open submission.', location: 'Global' },
