...
type Tab = 'edu' | 'social' | 'royalty' | 'revenue';
    ...
    <div className="min-h-screen bg-[#0b0b1a] p-4 md:p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        <header>
          ...
          <p className="text-zinc-500 mt-1">AI tools for growth, social media, and revenue.</p>
        </header>
        ...
        <main className="mt-8">
          ...
          {activeTab === 'revenue' && artist && (
            <RevenueTracker artistId={artist.id} />
          )}
